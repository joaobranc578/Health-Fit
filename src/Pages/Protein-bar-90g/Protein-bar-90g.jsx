      ...
      <main className="product-page container2">
        ...
        <section className="center-gallery">
          <div className="gallery">
            <div className="main-image">
              <img src="/img/Barra-90g.png" alt="Power Protein Bar 90G" />
            </div>
            <div className="thumbs">
              <img src="/img/Barra-90g.png" alt="thumb1" />
        ...
        <aside className="right-buy">
          <div className="buy-card">
            ...
            <h2>Power Protein Bar 90G</h2>
            <div className="rating">★★★★☆</div>

            <div>R$ <s>R̶$ 154,90</s></div>
            <div className="price-big">R$ <strong>R$ 117,24</strong></div>
            <div className="parcel">Até 4x de R$ 30,85</div>
